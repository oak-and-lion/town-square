public class MemberAliasUpdateThread extends Thread implements IMemberAliasUpdateThread {
    ...
    public void run() {
        try {
            ...
            aliases = utility.readFile(utility.concatStrings(square.getSafeLowerName(), Constants.ALIAS_FILE_EXT)).split(Constants.READ_FILE_DATA_SEPARATOR);
    ...
    private void processAliasMembers(String data, IClient client, String uniqueId) {
        ...
        String encryptedData = utility.encrypt(utility.concatStrings(Constants.REGISTER_ALIAS_COMMAND
            ...
            , uniqueId), password);
        String request = utility.concatStrings(encryptedPassword, Constants.COMMAND_DATA_SEPARATOR, encryptedData);
