...
appjarfile="_new_Hub.jar"
appverfile="_new_Hub.ver"
if [ -f $appjarfile ]
then
...
./jdk-11.0.2.jdk/Contents/Home/bin/java --module-path "javafx/lib" --add-modules "javafx.controls,javafx.fxml,javafx.media" -jar Hub.jar -cl